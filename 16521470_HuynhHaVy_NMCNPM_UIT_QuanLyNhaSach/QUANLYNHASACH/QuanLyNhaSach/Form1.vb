...
Public Class Form1
    ...
    Private Sub KháchHàngToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles KháchHàngToolStripMenuItem1.Click
        Dim tracuukhachhang As New TRACUUKHACHHANG
    ...
    Private Sub QuảnLíNhânViênToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles QuảnLíNhânViênToolStripMenuItem.Click
        Dim quanlynhanvien As New QUANLYNHANVIEN
        quanlynhanvien.MdiParent = Me
        quanlynhanvien.Show()
    End Sub

    Private Sub NhânViênToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles NhânViênToolStripMenuItem.Click
        Dim tracuunhanvien As New TRACUUNHANVIEN
        tracuunhanvien.MdiParent = Me
        tracuunhanvien.Show()
    End Sub
End Class