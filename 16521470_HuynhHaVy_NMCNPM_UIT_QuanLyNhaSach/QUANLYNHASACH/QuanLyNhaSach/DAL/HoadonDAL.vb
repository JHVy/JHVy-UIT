...
Namespace HoadonDAL
    Public Class HoadonDAL
        ...
        Public Function Hienthihoadon() As DataTable
            Dim sql As String = "select HOADON.*,KHACHHANG.Hotenkhachhang from HOADON,KHACHHANG where HOADON.Makhachhang= KHACHHANG.Makhachhang"
        ...
        Public Function Themhoadon(ByVal hd As HoadonDTO) As String
            Dim sql As String = "insert into HOADON(Mahoadon,Makhachhang,Ngaylaphoadon,Tongthanhtien) values(N'" & hd.Mahoadon.Trim & "',N'" & hd.Makhachhang.Trim & "','" & hd.Ngaylaphoadon & "','" & hd.Tongthanhtien & "')"
