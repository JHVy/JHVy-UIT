...
Namespace HoadonDAL
    Public Class HoadonDAL
        ...
        Public Function Themhoadon(ByVal hd As HoadonDTO) As String
            Dim sql As String = "insert into HOADON(Mahoadon,Makhachhang,Ngaylaphoadon,Tongthanhtien) values('" & hd.Mahoadon.Trim & "','" & hd.Makhachhang.Trim & "','" & hd.Ngaylaphoadon & "','" & hd.Tongthanhtien & "')"
